...
def PreActResNet10(activation):
    return PreActResNet(PreActBlock, [1, 1, 1, 1], activation=activation)


def PreActResNet18(activation):
    return PreActResNet(PreActBlock, [2, 2, 2, 2], activation=activation)
