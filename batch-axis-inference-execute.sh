...
commands=(
  ...
  "(OMP_NUM_THREADS=18 /usr/bin/time -v numactl -N 3 -m 3 ./bin/main -P N16384_L5_50-30 -D mnist -M 3layer_cnn-relu_rg5_deg2-BN --model-params 3layer_cnn-relu_rg5_deg2-BN-99.36_200epoch-1223_1247-params.h5 -A relu_rg5_deg2 --fuse-layer --opt-act --mode batch -N 2)"
  "(OMP_NUM_THREADS=18 /usr/bin/time -v numactl -N 3 -m 3 ./bin/main -P N16384_L5_50-30 -D mnist -M 3layer_cnn-relu_rg7_deg2-BN --model-params 3layer_cnn-relu_rg7_deg2-BN-99.49_200epoch-1223_1508-params.h5 -A relu_rg7_deg2 --fuse-layer --opt-act --mode batch -N 2)"
  "(OMP_NUM_THREADS=18 /usr/bin/time -v numactl -N 3 -m 3 ./bin/main -P N16384_L7_50-30 -D mnist -M 3layer_cnn-relu_rg5_deg4-BN --model-params 3layer_cnn-relu_rg5_deg4-BN-99.39_200epoch-1223_1730-params.h5 -A relu_rg5_deg4 --fuse-layer --opt-act --mode batch -N 2)"
  "(OMP_NUM_THREADS=18 /usr/bin/time -v numactl -N 3 -m 3 ./bin/main -P N16384_L7_50-30 -D mnist -M 3layer_cnn-relu_rg7_deg4-BN --model-params 3layer_cnn-relu_rg7_deg4-BN-99.43_200epoch-1223_1951-params.h5 -A relu_rg7_deg4 --fuse-layer --opt-act --mode batch -N 2)"
  # MNIST: Swish approx. (rg5_deg2, rg7_deg2, rg5_deg5, rg7_deg4) [Level: 5 or 7]
  "(OMP_NUM_THREADS=18 /usr/bin/time -v numactl -N 3 -m 3 ./bin/main -P N16384_L5_50-30 -D mnist -M 3layer_cnn-swish_rg5_deg2-BN --model-params 3layer_cnn-swish_rg5_deg2-BN-99.48_200epoch-1223_2212-params.h5 -A swish_rg5_deg2 --fuse-layer --opt-act --mode batch -N 2)"
  "(OMP_NUM_THREADS=18 /usr/bin/time -v numactl -N 3 -m 3 ./bin/main -P N16384_L5_50-30 -D mnist -M 3layer_cnn-swish_rg7_deg2-BN --model-params 3layer_cnn-swish_rg7_deg2-BN-99.42_200epoch-1224_0038-params.h5 -A swish_rg7_deg2 --fuse-layer --opt-act --mode batch -N 2)"
  "(OMP_NUM_THREADS=18 /usr/bin/time -v numactl -N 3 -m 3 ./bin/main -P N16384_L7_50-30 -D mnist -M 3layer_cnn-swish_rg5_deg4-BN --model-params 3layer_cnn-swish_rg5_deg4-BN-99.48_200epoch-1224_0307-params.h5 -A swish_rg5_deg4 --fuse-layer --opt-act --mode batch -N 2)"
  "(OMP_NUM_THREADS=18 /usr/bin/time -v numactl -N 3 -m 3 ./bin/main -P N16384_L7_50-30 -D mnist -M 3layer_cnn-swish_rg7_deg4-BN --model-params 3layer_cnn-swish_rg7_deg4-BN-99.52_200epoch-1224_0536-params.h5 -A swish_rg7_deg4 --fuse-layer --opt-act --mode batch -N 2)"
